# 🧪 Hands-On Labs — Mini Bootcamp Google Generative AI

> **Setup awal (wajib sebelum mulai):**
> ```bash
> pip install google-generativeai pillow SpeechRecognition gTTS requests scikit-learn numpy
> ```
> Dapatkan API Key di: https://aistudio.google.com/apikey

---

## 🔑 Setup API Key (Shared untuk semua lab)

```python
import google.generativeai as genai

GOOGLE_API_KEY = "ISI_API_KEY_KALIAN_DI_SINI"
